...
const DhopContext = React.createContext();
...
class DhopProvider extends Component {
...
const DhopProviderhopConsumer = DhopContext.Consumer

export {DhopConsumer, DhopContext}



export default DhopProvider
