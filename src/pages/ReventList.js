...
export default function ReventList() {
...
<div 
    ...
    >
      ...
      <div key={post.sys.id} className='col-span-1 relative'>

      <img className='w-full h-80 object-cover absolute ' src={post.fields.eventImage.fields.file.url} alt="" />
      ...
      <p className='tracking-tighter text-3xl text-center'>Party at Good Beach</p>

      <p className='tracking-tighter text-xl text-center'>Starting at ₦{post.fields.ticketPrices}</p>

      <Link to={`/eventDetails/${post.sys.id}`}  className="text-base tracking-tighter   ">
